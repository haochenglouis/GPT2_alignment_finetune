...
from dataset import DahoasRMStaticDataset,safety_step2_dataset
...
def train(pretrain, batch_size, exp_name):
    ...
    train_ds = safety_step2_dataset(block_size=1024,
                                     split='train',
                                     max_examples=None,
                                     tokenizer_name="tiktoken/gpt2")
    test_ds = safety_step2_dataset(block_size=1024,
                                    split='test',
                                    max_examples=None,
                                    tokenizer_name="tiktoken/gpt2")
