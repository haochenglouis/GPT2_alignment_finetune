...
class safety_step3_dataset(Dataset):
    ...
    def __init__(self,
                 ...
                 tokenizer_name='tiktoken/gpt2') -> None:
        super().__init__()
        dataset = np.load("./gpt2_safety_alignment/gpt2_step3_q_in_step2.npy")
        self.prompts = []
...
class safety_step1_dataset(Dataset):
    ...
    def __init__(self,
        ...
        super().__init__()
        if split == "train":
            with open("./gpt2_safety_alignment/gpt2_step1.pkl","rb") as fp:
                dataset = pickle.load(fp)['train']
        else:
            with open("./gpt2_safety_alignment/gpt2_step1.pkl","rb") as fp:
                dataset = pickle.load(fp)['test']
        self.tokens = []
        self.block_size = block_size
        if tokenizer_name == "huggingface/gpt2":
            tokenizer = GPT2Tokenizer.from_pretrained('gpt2')
...
class safety_step2_dataset(Dataset):
    """
    https://huggingface.co/datasets/Dahoas/rm-static
    """
    ...
    def __init__(self,
        ...
        super().__init__()
        if split == "train":
            with open("./gpt2_safety_alignment/gpt2_step2.pkl","rb") as fp:
                dataset = pickle.load(fp)['train']
        else:
            with open("./gpt2_safety_alignment/gpt2_step2.pkl","rb") as fp:
                dataset = pickle.load(fp)['test']
